...
| carpal/dist/data/customer/Order    | updateJobLiveData(existingJobs, pubSubPayload) | This returns update Jobs with both activeStatusCounts and totalStatusCounts counts. <br /><br />|
