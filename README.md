...
The current version of this SDK is **0.0.60**
...
| carpal/dist/data/customer/Order    | getOrdersWithFilterAsync(filterObject, customerId, token) | This returns a Promise object with all customer's orders. <br /><br />The **filterObject** payload example {pickup_date: '2017-11-06', order_status_id: [1, 2, 3]} <br /><br />**To utilize the function, customerId must be provided.** |
