...
| carpal/dist/data/customer/Setting  | getSettingAsync(settingId, {identityId, productTypeId, transactionGroupId}, token)                                    | This returns a Promise object (reject/resolve). <br />Example. **identityId (mandatory)(int) = 1<br />\*\*productTypeId (mandatory)(integer) = 3** <br />\*\*transactionGroupId (mandatory)(integer) = 1\*\*                                                                                                                                                                                                                                                                                                        |
| carpal/dist/data/customer/Setting  | getSettingsAsync(token)                                                                                               | This returns a Promise object (reject/resolve). <br />\*\*                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
